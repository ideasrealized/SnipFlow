...
const ChainOptionItem: React.FC<ChainOptionItemProps> = ({
  option,
  onOptionChange,
  onDeleteOption,
}) => {
  ...
  const styles = {
    ...
    textarea: {
      ...
      color: '#e0e0e0',
      minHeight: '80px',
      resize: 'vertical' as const, // Explicitly type resize property
    },
    deleteButton: {
      padding: '5px 10px',
      background: '#c0392b',
      ...
      borderRadius: '3px',
      cursor: 'pointer',
      float: 'right' as const, // Explicitly type float property
    },
  };
